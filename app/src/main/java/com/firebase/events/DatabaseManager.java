...
public class DatabaseManager extends SQLiteOpenHelper implements Constants {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE IF NOT EXISTS " + TABLE_EVENTS + " (" +COLUMN_ID  + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_EVENTS_ID + " INTEGER," + COLUMN_EVENT_NAME + " TEXT, "+COLUMN_EVENT_IMAGE+" TEXT ,"+COLUMN_EVENT_DESCRIPTION+" TEXT,"+COLUMN_EVENT_CATEGORY+" TEXT,"+COLUMN_EVENT_EXPERIENCE+" TEXT,"+COLUMN_IS_FAVORITE+" TEXT)";
        db.execSQL(sql);
